...
function CardForm(props: any) {
	...
	function orderChange(e: React.ChangeEvent<HTMLInputElement | HTMLTextAreaElement>): void {
		const regex = /^[0-9\b]+$/;
    ...
    return (
		<div>
			...
			<form onSubmit={createCard}>				
					...
					<Grid container direction="column">	
						{
							props.status === "edit" ? <Button type="submit">Update Card</Button> : <Button type="submit">Create Card</Button>
						}
					</Grid>				
			</form>
			</FormGroup>
